...
# ## Setup
# ## "stream": False means the response is delivered only when it's fully generated, not partially in real-time.
config_list = [
    {
...
def query_sql_database(query: str) -> List[Any]:
    ...
    db_path = Path(r"/Users/dongan/HouseDNA_Agent/csv_xlsx_sqldb.db")
