...
# Add this in your Python script to debug API key
...
config_list = [
    {
        # Let's choose the Llama-3.1-8B model
...
def fetch_zillow_data(location: str = None, page: int = 1, status_type: str = None, home_type: str = None, sort: str = None,
    ...
    conn = http.client.HTTPSConnection("zillow-com1.p.rapidapi.com", context = context)
...
# ## The task! prompt the user for input
...
If you need to fetch zillow data call the function, do not generate new code call the fetch_zillow_data() function. Max output is 5 listings.
...
executor = autogen.ConversableAgent(
    ...
    "engineer and report the result with max token less than 7000.",
    human_input_mode="NEVER",
...
writer = autogen.ConversableAgent(
    ...
    Every time you generate a report, ALWAYS save it as a markdown file by calling the save_markdown_file() function.
